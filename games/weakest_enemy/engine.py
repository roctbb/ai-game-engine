...
CONFIG = {
  ...
  "kind": "weakest_enemy",
  "instruction": "Определите функцию choose_target(enemies), которая возвращает id врага: минимальный hp, затем меньшая distance, затем большая reward.",
