...
CONFIG = {
  "dir": "priority_tower",
  "id": "priority_tower_v1",
  "title": "Башня приоритета",
  "difficulty": "medium",
  ...
  "kind": "priority_tower",
  "instruction": "Определите функцию choose_target(enemies), которая выбирает цель по счету опасности, дистанции и hp.",
