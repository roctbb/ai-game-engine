...
CONFIG = {
  "dir": "treasure_scanner",
  "id": "treasure_scanner_v1",
  "title": "Сканер сокровищ",
  "difficulty": "medium",
  ...
  "kind": "treasure_scanner",
  "instruction": "Определите функцию scan(board), которая возвращает самый выгодный ряд или столбец: сумма сокровищ минус стоимость сканирования.",
