...
CONFIG = {
  "dir": "archer_duel_lite",
  "id": "archer_duel_lite_v1",
  "title": "Дуэль лучников Lite",
  "difficulty": "medium",
  "section": "Соревновательные стратегии",
  "topics": [
    "соревнование",
    "условия",
    "ресурсы"
  ],
  "kind": "archer_duel_lite",
  "mode": "small_match",
  "instruction": "Определите функцию make_move(state), которая возвращает aim/shoot/shield/reload.",
  "learning_section": "Соревновательные стратегии",
  "slots": [
    {
      "key": "left"
    },
