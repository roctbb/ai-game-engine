...
def make_move(x, y, board, carrying, players=None, bases=None):
    ...
    if steal_target is not None:
        return step_to_point(x, y, board, steal_target, [("right", 1, 0), ("down", 0, 1), ("left", -1, 0), ("up", 0, -1)])
...
def step_to_point(x, y, board, target_point, directions):
    return step_to(x, y, board, target_point, directions)
