...
CONFIG = {
  "dir": "battery_robot_lite",
  "id": "battery_robot_lite_v1",
  "title": "Батарейный робот Lite",
  "difficulty": "medium",
  "section": "Счетчики и ресурсы",
  "topics": [
    "переменные",
    "батарейка",
    "условия",
  ...
  "kind": "battery_robot_lite",
  "instruction": "Определите функцию choose_action(state), которая возвращает clean/charge/return_to_charger/move/wait.",
  "learning_section": "Счетчики и ресурсы",
  "mode": "single_task",
  "slots": [
    {
      "key": "agent"
