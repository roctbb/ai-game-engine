...
CONFIG = {
  ...
  "kind": "pixel_painter",
  "instruction": "Определите функцию paint(pixels, palette), которая возвращает цветную матрицу, а неизвестные коды заменяет на transparent.",
