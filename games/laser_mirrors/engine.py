...
CONFIG = {
  "dir": "laser_mirrors",
  "id": "laser_mirrors_v1",
  "title": "Лазер и зеркала",
  "difficulty": "hard",
  "section": "Симуляции мира",
  "topics": [
    "симуляция",
    "координаты",
    "while"
  ...
  "kind": "laser_mirrors",
  "instruction": "Определите функцию trace(board, start_x, start_y, dx, dy), которая возвращает True, если луч попал в цель, учитывая зеркала, стены и поглотители.",
  "learning_section": "Симуляции мира",
  "mode": "single_task",
  "slots": [
    {
      "key": "agent"
