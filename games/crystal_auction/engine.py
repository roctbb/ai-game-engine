...
CONFIG = {
  "dir": "crystal_auction",
  "id": "crystal_auction_v1",
  "title": "Аукцион кристаллов",
  "difficulty": "hard",
  ...
  "kind": "crystal_auction",
  "mode": "small_match",
  "instruction": "Определите функцию bid(state), которая возвращает ставку на текущий кристалл.",
