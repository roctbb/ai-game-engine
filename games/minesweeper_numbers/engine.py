...
CONFIG = {
  "dir": "minesweeper_numbers",
  "id": "minesweeper_numbers_v1",
  "title": "Сапер-редактор",
  "difficulty": "medium",
  ...
  "kind": "minesweeper_numbers",
  "instruction": "Определите функцию build_numbers(mines), которая возвращает поле чисел вокруг мин, аккуратно обрабатывая края и углы.",
