...
CONFIG = {
  "dir": "wall_archer",
  "id": "wall_archer_v1",
  "title": "Лучник на стене",
  "difficulty": "easy",
  "section": "Условия и выбор",
  "topics": [
    "if",
    "сравнения",
    "ресурсы",
  ...
  "kind": "wall_archer",
  "instruction": "Определите функцию choose_action(enemy, arrows, hp), которая возвращает shoot/reload/shield/wait с учетом угрозы, брони и стрел.",
