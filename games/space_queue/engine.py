...
CONFIG = {
  "dir": "space_queue",
  "id": "space_queue_v1",
  "title": "Очередь кораблей",
  "difficulty": "medium",
  "section": "Списки и цели",
  "topics": [
    "списки",
    "очередь",
    "сортировка",
  ...
  "kind": "space_queue",
  "instruction": "Определите функцию schedule(ships), которая возвращает id кораблей по срочности: priority*10 + passengers*2 + broken*20 + (10-fuel) - service_time.",
