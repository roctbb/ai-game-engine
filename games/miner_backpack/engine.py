...
CONFIG = {
  "dir": "miner_backpack",
  "id": "miner_backpack_v1",
  "title": "Рюкзак шахтера",
  "difficulty": "medium",
  ...
  "kind": "miner_backpack",
  "instruction": "Определите функцию solve(ores, capacity), которая возвращает команды take/skip для руды с учетом веса и ценности.",
