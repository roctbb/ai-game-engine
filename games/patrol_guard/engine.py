...
CONFIG = {
  "dir": "patrol_guard",
  "id": "patrol_guard_v1",
  "title": "Патрульный страж",
  "difficulty": "medium",
  "section": "Режимы поведения",
  "topics": [
    "состояния",
    "режимы",
    "условия",
  ...
  "kind": "patrol_guard",
  "instruction": "Определите функцию choose_actions(events), которая возвращает patrol/attack/return_to_route/investigate.",
  "learning_section": "Режимы поведения",
  "mode": "single_task",
  "slots": [
    {
      "key": "agent"
