...
def run(context: dict[str, Any] | None = None) -> dict[str, object]:
    ...
    turns = 0
    frames = [_frame(0, "running", positions, walls, gems, collected, invalid)]
    ...
    for turn in range(_MAX_TURNS):
        ...
        turns = turn + 1
        frames.append(_frame(turns, "running", positions, walls, gems, collected, invalid))
    ...
    frames.append(_frame(len(frames), "finished", positions, walls, gems, collected, invalid, slot_scores))
