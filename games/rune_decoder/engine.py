...
CONFIG = {
  "dir": "rune_decoder",
  "id": "rune_decoder_v1",
  "title": "Расшифровщик рун",
  "difficulty": "easy",
  "section": "Строки и коды",
  "topics": [
    "строки",
    "цикл по строке",
    "таблица команд"
  ...
  "kind": "rune_decoder",
  "instruction": "Определите функцию decode(runes), которая переводит строку рун, включая руну ожидания, в список команд.",
  "learning_section": "Строки и коды",
  "mode": "single_task",
  "slots": [
    {
      "key": "agent"
