...
CONFIG = {
  "dir": "farm_row",
  "id": "farm_row_v1",
  "title": "Грядка фермера",
  "difficulty": "easy",
  "section": "Циклы и повторения",
  "topics": [
    "for",
    "range",
    "циклы",
  ...
  "kind": "farm_row",
  "instruction": "Определите функцию solve(row), которая возвращает water для растений с влажностью меньше 3, иначе skip.",
